...
constexpr int kGestureCount = 7;
constexpr int kSitStandGesture = 0;
constexpr int kWalkGesture = 1;
constexpr int kLiedownGesture = 2;
constexpr int kJumpGesture = 3;
constexpr int kTransitionUndefinedGesture = 4;
constexpr int kStairsupGesture = 5;
constexpr int kStairsdownGesture = 6;
